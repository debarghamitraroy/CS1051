...
/* Function to check if filename exists in list */
...
/* Function to read all filenames from a directory into an array */
...
int main() {
    ...
    // Open data directories (folder1, folder2)
    DIR *dir1, *dir2;
    dir1 = opendir(folder1);
    dir2 = opendir(folder2);

    // Create a network socket for communication
